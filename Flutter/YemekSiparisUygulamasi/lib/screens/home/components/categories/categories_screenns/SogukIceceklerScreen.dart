...
class SogukIceceklerScreen extends StatelessWidget {
  const SogukIceceklerScreen({super.key});

  @override
  Widget build(BuildContext context) {
    final product_state = Provider.of<ProductState>(context, listen: false);
    final List<Product> filterProduct =
        product_state.Allproducts.where((element) => element.CATEGORYREF == 1).toList();
    return Scaffold(
        appBar: AppBar(
